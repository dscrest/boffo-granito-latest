...
export function Icon({ name, size = 14, className = "", strokeWidth = 1.75, style }: IconProps) {
  ...
  switch (name) {
    ...
    case "qr": return <svg {...common}><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3M17 14v3M14 17v.01M17 17v4M20 17v.01M20 20v.01"/></svg>;
