...
| CR | Change | Status | Evidence |
|---|---|---|---|
| 177 | **SO Production tab drops the Remaining column** (Requested and Produced stay) — sibling of CR-164's column trims on the same page. | **DEPLOYED LIVE 2026-09-14** (client-only), commit pending | [`OrderDetail.tsx`](../client/src/features/orders/OrderDetail.tsx) (`SoProduction`). |
